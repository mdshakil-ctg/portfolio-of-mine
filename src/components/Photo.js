   ...
   return (
      <div>
         ...
         <h2 className='text-3xl font-semibold text-start text-yellow-500'>Resale <span className='text-white'>Planet</span></h2>
            ...
            <a className='btn btn-outline btn-warning btn-sm mt-10' href='https://photo-hunters-51258.web.app/'>Live Website</a>
            <a className='btn btn-outline btn-warning btn-sm mt-10 mx-3' href='https://github.com/mdshakil-ctg/photo-hunters'>Github Client Code</a>
            <a className='btn btn-outline btn-warning btn-sm mt-10' href='https://github.com/Porgramming-Hero-web-course/b6a11-service-review-server-side-mdshakil-ctg'>Github Server Code</a>
            </div>
      </div>
   );
};
